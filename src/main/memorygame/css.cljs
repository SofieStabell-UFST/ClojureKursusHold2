(ns memorygame.css)
;; Stolen from https://gist.github.com/kirked/7aefc94d1a45435a038728d26fd9b373


(defn classes-of
      "Get the classes of an element as a Clojure keyword vector."
      [e]
      (let [words (-> e (.getAttribute "class") (clojure.string/split " "))]
           (mapv keyword words)))

(defn classes->str
      "Change a Clojure keyword seq into an HTML class string."
      [classes]
      (->> classes (mapv name) (clojure.string/join " ")))
