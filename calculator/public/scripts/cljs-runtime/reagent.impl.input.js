...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__36369){
var map__36370 = p__36369;
var map__36370__$1 = (((((!((map__36370 == null))))?(((((map__36370.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36370.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__36370):map__36370);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36370__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__36376_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__36376_SHARP_);
}));
