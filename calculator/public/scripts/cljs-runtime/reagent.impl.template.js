...
var G__36384 = o;
goog.object.set(G__36384,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36385 = o;
goog.object.set(G__36385,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__36414__i = 0, G__36414__a = new Array(arguments.length -  0);
while (G__36414__i < G__36414__a.length) {G__36414__a[G__36414__i] = arguments[G__36414__i + 0]; ++G__36414__i;}
  args = new cljs.core.IndexedSeq(G__36414__a,0,null);
} 
return G__36412__delegate.call(this,args);};
G__36412.cljs$lang$maxFixedArity = 0;
G__36412.cljs$lang$applyTo = (function (arglist__36416){
var args = cljs.core.seq(arglist__36416);
...
var G__36386 = props;
var G__36386__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36386,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36386);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36386__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36387 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36387,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36387;
}
})(),id_class);
...
var G__36388 = (cljs.core.count(argv) - first_child);
switch (G__36388) {
case (0):
...
var vec__36389 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36389,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36389,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36389,(2),null);
...
var temp__5739__auto___36431 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___36431 == null)){
} else {
var key_36432 = temp__5739__auto___36431;
(jsprops.key = key_36432);
}
...
var temp__5739__auto___36435 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5739__auto___36445 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___36445 == null)){
} else {
var key_36446 = temp__5739__auto___36445;
(jsprops.key = key_36446);
}
...
var temp__5739__auto___36461 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___36461 == null)){
} else {
var key_36462 = temp__5739__auto___36461;
(jsprops.key = key_36462);
}
...
var temp__5739__auto___36463 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___36463 == null)){
} else {
var key_36464 = temp__5739__auto___36463;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36392_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36392_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36393 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36393,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36393,(1),null);
...
break;
default:
var G__36494 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36495 = compiler;
v = G__36494;
compiler = G__36495;
continue;
...
var G__36397 = tag;
var G__36397__$1 = (((G__36397 instanceof cljs.core.Keyword))?G__36397.fqn:null);
switch (G__36397__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36399 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36399 = (function (opts,id,fn_to_element,meta36400){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta36400 = meta36400;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template36399.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36401,meta36400__$1){
var self__ = this;
var _36401__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36399(self__.opts,self__.id,self__.fn_to_element,meta36400__$1));
}));

(reagent.impl.template.t_reagent$impl$template36399.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36401){
var self__ = this;
var _36401__$1 = this;
return self__.meta36400;
}));

(reagent.impl.template.t_reagent$impl$template36399.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36399.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36399.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36399.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36399.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta36400","meta36400",-1204463432,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36399.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36399.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36399");

(reagent.impl.template.t_reagent$impl$template36399.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template36399");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36399.
 */
reagent.impl.template.__GT_t_reagent$impl$template36399 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36399(opts__$1,id__$1,fn_to_element__$1,meta36400){
return (new reagent.impl.template.t_reagent$impl$template36399(opts__$1,id__$1,fn_to_element__$1,meta36400));
});

}

return (new reagent.impl.template.t_reagent$impl$template36399(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
