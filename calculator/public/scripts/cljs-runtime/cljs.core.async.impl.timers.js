...
var i_29012 = (self__.level + (1));
while(true){
if((i_29012 <= (new_level + (1)))){
(update[i_29012] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29017 = (update[i]).forward;
(x__$2.forward[i] = (links_29017[i]));
...
if((x__$1 === (((i_29020 < links_29021.length))?(links_29021[i_29020]):null))){
(links_29021[i_29020] = (x__$1.forward[i_29020]));

var G__29026 = (i_29020 + (1));
i_29020 = G__29026;
continue;
} else {
var G__29027 = (i_29020 + (1));
i_29020 = G__29027;
continue;
}
} else {
