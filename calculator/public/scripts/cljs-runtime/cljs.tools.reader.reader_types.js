...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26160 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26160(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26163 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26163(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26167 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26167(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26168 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26168(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26180 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26180(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26186 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26186(reader);
}
});
...
var G__26277 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26278 = s.append(c);
c = G__26277;
s = G__26278;
continue;
}
